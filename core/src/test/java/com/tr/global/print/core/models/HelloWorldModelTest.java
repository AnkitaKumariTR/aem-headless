 ...
 */
package com.tr.global.print.core.models;
...
import com.tr.global.print.core.testcontext.AppAemContext;
...
class HelloWorldModelTest {
    ...
    public void setup() throws Exception {
        ...
        resource = context.create().resource(page, "hello",
            "sling:resourceType", "global-print-store/components/helloworld");
